...
@register
Scenario Outline: User clik on register button with username and password fields empty
Given New user is on Register page
When User click on register button
Then User should land on Register page
When User click on register button with username "<Sheetname>" and password <RowNumber> as blank
